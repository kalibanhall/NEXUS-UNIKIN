          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input id="lastName" defaultValue="MUTOMBO" />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="email">Email</Label>
                <Input id="email" type="email" defaultValue="employe.mutombo@unikin.ac.cd" disabled />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="service">Service</Label>
                <Input id="service" defaultValue="Secrétariat académique" disabled />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="phone">Téléphone</Label>
                <Input id="phone" defaultValue="+243 999 876 543" />
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Être notifié des nouvelles tâches</p>
              </div>
              <Switch 
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium">Demandes de documents</p>
                <p className="text-sm text-gray-500">Être notifié des nouvelles demandes</p>
              </div>
              <Switch 
